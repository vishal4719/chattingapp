...
export function NotificationBanner() {
  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem("notifications-banner-dismissed") === "1") return;
  ...
  function handleDismiss() {
    sessionStorage.setItem("notifications-banner-dismissed", "1");
    setVisible(false);
  }
  ...
  return (
    <div className="shrink-0 px-3 py-2 bg-[var(--wa-green)]/15 border-b border-[var(--wa-green)]/30 flex items-center gap-3 text-sm">
      ...
      <p className="flex-1 text-[var(--wa-text)]">
